package com.easynet.controller.ApiController.QRAPI;
...
public class GetQRDataById {
    ...
    public String getQRDataById(String reqData) {
        ...
        try {
            ...
            //qrapping the request in GetQrdataById object.
            ...
            try {
                ...
                System.out.println("GetQrDataById SoapFaultClientException : " + actualErrMsg);
	     ...
	     * If response is 101 then no records found.
            ...
            } else if (ls_responseCode != null && "101".equals(ls_responseCode)) {
                ls_responseData = common.ofGetErrDataJsonArray("99", "Validation Failed.", "InValid account number.", ls_responseMessage, "", ls_responseCode, "R");
            ...
            System.out.println("GetQrDataById Exception : " + actualErrMsg);
